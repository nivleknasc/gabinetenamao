...
// Importar os componentes de mapa dinamicamente, sem SSR
const ClientSideMap = dynamic(() => import('./ClientSideMap'), { ssr: false });
const ClientSideRegions = dynamic(() => import('./ClientSideRegions'), { ssr: false });
